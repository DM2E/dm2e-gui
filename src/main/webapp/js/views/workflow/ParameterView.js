...
//            TODO
        ...
        addConnectionTo : function(draggable) {
            ...
            // fromParam
            conn[NS.expand("omnom:fromParam")] = source;

            // toParam
            conn[NS.expand("omnom:toParam")] = target;
//            conn[NS.expand("omnom:from")]

            // fromWorkflow/fromPosition
            conn[source.paramType === 'workflow' ? NS.expand("omnom:fromWorkflow") :
                NS.expand("omnom:fromPosition")] = sourceParent;

            // toWorkflow/toPosition
            conn[target.paramType === 'workflow' ? NS.expand("omnom:toWorkflow") :
                NS.expand("omnom:toPosition")] = targetParent;
